// opencl_tmerc_wgs84_marks.cpp
// Compare performance of several backends for wgs84 tmerc
...
int main() {
	...
	for (int i = 1 ; i <= 5 ; i ++) {
		...
		long long t_proj, t_mproj, t_cpu, t_mcpu, t_ccl, t_gcl;
