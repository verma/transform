...
int main() {
	...
	typedef cartographic::projections::latlong								proj_from;
	typedef cartographic::projections::tmerc<cartographic::ellipsoids::WGS84, double>		proj_to;

	projection<proj_from, proj_to> p(proj_from(), proj_to(proj_to::offset_t(0.0, 0.0)));
